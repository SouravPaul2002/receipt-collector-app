...
| [`frontend/app/login/page.tsx`](file:///c:/receipt-collector/frontend/app/login/page.tsx) | Google OAuth authentication page. | Displays brand value proposition, BYOS highlights, and 1-click Google sign-in redirecting to `/api/auth/google`. |
